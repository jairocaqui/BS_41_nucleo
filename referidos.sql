...
select r.referidoid,p.multitablaidtipodocumento, p.nrodocumento,p.nombre,
p.apellidopaterno, r.empresa, r.edad, p.telefono, p.email, p.direccion,
r.ubigeoid,u.nombre, r.categoriaproductoid, c.nombre, r.productoid, k.nombre,
r.fuenteid, f.nombre, r.usuarioidregistra, p.nombre, r.comentario,
r.fecharegistra, r.usuarioidasignado, p.nombre, r.respuesta_cita,
r.respuesta_contacto, r.respuesta_venta, r.respuesta_seguimiento, r.fecha_contacto,
r.fecha_cita, p.fecha_nacimiento, r.placa_vehiculo, r.campaign_source,
r.campaign_name, r.campaign_medium, r.first_visit, r.current_visit_started,
r.times_visited, r.adicional, '202204' as anio_mes_operacion
