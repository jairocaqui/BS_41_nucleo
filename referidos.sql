...
from 	   REFERIDOS.ODS_REF_REFERIDO r
inner join REFERIDOS.ODS_REF_PERSONA p on r.personaid=p.personaid
inner join REFERIDOS.ODS_REF_UBIGEO u on r.ubigeoid=u.ubigeoid
inner join REFERIDOS.ODS_REF_CATEGORIA_PRODUCTO c on r.categoriaproductoid=c.categoriaproductoid
inner join REFERIDOS.ODS_REF_PRODUCTO k on r.productoid=k.productoid
inner join REFERIDOS.ODS_REF_FUENTE f on r.fuenteid=f.fuenteid
